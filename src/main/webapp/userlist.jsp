				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">${sessionScope.loginRole}[${sessionScope.loginUser.username}]
							<span class="caret"></span>
						</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">个人资料</a></li>
								<li class="divider"></li>
								<li><a href="${pageContext.request.contextPath}/exit/exit.do">安全退出</a></li>
							</ul></li>
					</ul>
				</div>
		...
		<div class="col-md-12">
			...
			<table  style="text-align:center" id="userPager"
				...
				<tr class="bg-danger" >
					...
					<td style="display: none;">${sessionScope.loginUser.password}</td>
					<td>${sessionScope.loginUser.phone}</td>
					<td>${sessionScope.loginUser.email}</td>
					<td>${sessionScope.loginUser.systemSource}</td>
					<td>${sessionScope.loginUser.emailIp}</td>
				</tr>
				</tbody>
